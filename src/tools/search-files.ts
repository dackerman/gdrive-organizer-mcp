...
export const searchFilesSchema = z.object({
  ...
  folderId: z.string().optional().describe(
    'Limit search to a specific folder ID. Leave empty to search entire Drive.'
  ),
  ...
  namePattern: z.string().optional().describe(
  ...
  maxResults: z.number().min(1).max(1000).optional().default(50).describe(
