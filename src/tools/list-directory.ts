...
export const listDirectorySchema = z.object({
  ...
  includeShared: z.boolean().optional().default(true).describe('Include files shared with you. Set to false to only show files you own.'),

  onlyDirectories: z.boolean().optional().default(false).describe('Only return directories/folders, excluding files.'),
  ...
  pageSize: z
    ...
    .optional()
    .default(20)
    .describe('Number of results per page (1-100). Use smaller values to reduce response size.'),

  pageToken: z.string().optional().describe('Token from previous response to fetch the next page of results.'),
})
